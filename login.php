    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <img src="img/1.png" alt="Alimochtar" class="img-fluid" style="width: 100%;">
            </div>
                            ...
                            <div class="col-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Sistem Pakar <br> Deteksi Stunting</h1>
                                    </div>
                                ...
                                <button type="submit"
                                class="btn btn-info btn-user btn-block">Masuk</button>
                                ...
                                <a href="diagnosis"
                                class="btn btn-info btn-user btn-block">Masuk sebagai tamu</a>
