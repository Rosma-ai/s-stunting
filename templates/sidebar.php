...
<!-- Sidebar -->
<ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar" style="z-index:1200">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard">
        ...
        <div class="sidebar-brand-text mx-3">Sistem Pakar Deteksi Stunting</div>
    </a>
