                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Form Diagnosis Stunting</h6>
                                </div>
                                <div class="card-body">
                                    <form id="form-diagnosis" method="POST" action="">
                                        ...
                                        <button type="submit"
                                            class="mt-4 btn btn-success btn-block py-2">Diagnosis</button>
                        ...
                        <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Kalkulator Usia</h6>
                                </div>
                                <div class="card-body">
                                    <form id="usiaForm" onsubmit="hitungUsia(event)">
                                        ...
                                        <button type="submit" class="mt-4 btn btn-success btn-block py-2">Hitung
                                            Usia</button>
                                        <button type="button" class="btn btn-secondary btn-block py-2"
                                    ...
                                    <div class="mt-4 d-flex justify-content-center align-items-center text-center">
                                        <div class='col-12 card shadow'>
                                            <div class='card-body'>
                                                ...
                                                <button class="btn btn-info btn-block mt-3" onclick="copy()">
                        ...
                        <div class="col-lg-6 mb-4" id="result-diagnosis">
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Data Diagnosis</h6>
                                </div>
                                <div class="card-body row">
                                    ...
                                    <div class="col text-center d-none d-md-block">
                                        <img src="./img/2.png" alt="Foto Anak" style="max-height: 140px">
                                    </div>
                                </div>

                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Hasil Diagnosis</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Informasi Diagnosis</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Rekomendasi Diagnosis</h6>
                                </div>
                                <div class="card-body">
...
<script>
    function hitungUsia(event) {
        ...
        // Jika hari di bulan sekarang kurang dari hari lahir, kurangi satu bulan dari selisihBulan
        if (tglSekarang.getDate() < tglLahir.getDate()) {
            selisihBulan--;
        }

        // Jika selisihBulan negatif, tambahkan 12 bulan dan kurangi satu tahun dari selisihTahun
        if (selisihBulan < 0) {
            selisihBulan += 12;
            selisihTahun--;
        }
        ...
        let usiaDalamBulan = (selisihTahun * 12) + selisihBulan;

        // Tampilkan hasil usia maksimal hingga 60 bulan
        if (usiaDalamBulan > 60) {
            document.getElementById("hasil_usia").textContent = "Lebih dari 60";
        } else {
            document.getElementById("hasil_usia").textContent = usiaDalamBulan;
        }
    ...
    function copy() {
        ...
        input.setAttribute("value", hasilUsia + " Bulan");
